...
if(isset($_SESSION['user_name']) && isset($_POST['submit_user'])){

  $user_name=$_SESSION['user_name'];
  $db2 = "SELECT * FROM user WHERE user_name = '$user_name'";

  $s5 = mysqli_query($con,$db2);
  
//   $result = mysqli_fetch_array($s);
  
  // echo $result;

  $result5 = mysqli_fetch_array($s5);
  $Assign_Hospital= $result5['Assign_Hospital'];
// $Assign_Hospital= 'Hospital1';
echo $Assign_Hospital;
...
if(isset($_POST['upload_excel']) && isset($_SESSION['user_name'])){
